...
export default function Footer() {
  return (
    <footer className="bg-brand-dark text-white pt-20 pb-10 relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute top-0 left-0 w-64 h-64 bg-brand-primary/10 rounded-full blur-3xl -z-10"></div>
      <div className="absolute bottom-0 right-0 w-80 h-80 bg-brand-secondary/10 rounded-full blur-3xl -z-10"></div>
      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-12 mb-16">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 bg-white/10 rounded-xl flex items-center justify-center hover:bg-brand-primary transition-colors duration-300">
          ...
          <div>
            ...
            <ul className="space-y-4">
              {["Home", "About", "Subjects", "Pricing"].map((link) => (
                <li key={link}>
                  <Link 
                    to={link === "Home" ? "/" : `/${link.toLowerCase()}`}
                    className="text-gray-400 hover:text-brand-primary transition-colors duration-300 flex items-center gap-2 group"
                  >
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <a href="tel:+919876543210" className="text-gray-400 hover:text-brand-primary transition-colors">+91 98765 43210</a>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex flex-col md:flex-row items-center gap-2 text-gray-500 text-sm">
            <div>© {new Date().getFullYear()} Agnita Das. All rights reserved.</div>
            <span className="hidden md:inline text-gray-700">|</span>
            <div>Developed by Sayan Duary</div>
          </div>
